                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" name="date_of_birth" id="dobInput"
                                       ...
                                       value="{{ old('date_of_birth') }}" required onchange="calcAge(this.value)">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="address" class="form-control"
                                       value="{{ old('address') }}" placeholder="House No., Street, Barangay">
                            </div>
                        </div>
                    </div>
                </div>
...
@if(old('province'))
    loadCities('{{ old('province') }}', '{{ old('city') }}');
    calcAge('{{ old('date_of_birth') }}');
@endif
</script>
@endpush
@endsection